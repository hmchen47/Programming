...
def new(num_buckets=256):
    """Initializes a Map witht he given number of buckets"""
    aMap = []
...
def set(aMap, key, value):
    """Sets they key to the value, replacing any existing value."""
    bucket = get_bucket(aMap, key)
...
if __name__ == "__main__":
    ...
    print(get(states, 'New York'))
    print(get(cities, 'NY'))

    print(get(cities, get(states, 'New York')))
