...
=======
#### Knowledge check 5.5.5 (not graded)
>>>>>>> docs: add contents for 5.5.5 Pseudo classes and cursor
=======
#### Knowledge check 5.5.5
>>>>>>> docs: remove "not graded" in Mod05
...
<br/>
=======
>>>>>>> docs: add contents for 5.5.6 CSS best practices
...
<br/>
>>>>>>> docs: add contents for 5.5.7 Recipe project - Module 5 and discussion
...
>>>>>>> docs: add contents for Multimedia exercises (13-20)
...
=======
    Ans: b <br/>
    Explanation: Because there is no universally accepted video format, the <source> tag provides 'fallback' alternatives in case the browser doesn't support a particular video format or codec.
>>>>>>> docs: add contents for 5.5.3 CSS exercises (21-25)
